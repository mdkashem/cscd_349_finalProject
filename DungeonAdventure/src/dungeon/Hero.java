...
public abstract class Hero extends DungeonCharacter {
	...
	public String toString() {
		return "Hero [Name=" + name + ", Hit points="
				+ hitPoints + ", the total number of healing Potions =" + numOfHealing + ", total Vision Potions="
				+ numOfVision + ", Total number of OO pillers=" + numOfPiller + "]";
	}
